...
#
# Examples:
#   ./scripts/ss-sens/ss-sens-release.sh --version 1.2.0 --arch amd64
#   ./scripts/ss-sens/ss-sens-release.sh --version 1.2.0 --arch arm64 --bundle min
#   ./scripts/ss-sens/ss-sens-release.sh --bundle standard --with-metrics --yes
#   ./scripts/ss-sens/ss-sens-release.sh --no-images --no-docker-pkgs  # config-only test bundle
...
BUNDLE_SCRIPTS=(
  shared/common.sh
  ss-sens/ss-sens-ctl.sh
  ss-sens/ss-sens-bootstrap.sh
  ss-sens/ss-sens-compose.sh
  ss-sens/ss-sens-credentials.sh
  ss-sens/ss-sens-data-dirs.sh
  ss-sens/ss-sens-env.sh
  ss-sens/ss-sens-mosquitto-tls.sh
  ss-sens/ss-sens-mqtt-users.sh
)
...
cp "$PROJECT_ROOT/docker/ss-sens/docker-compose.ss-sens.yml" "$BUNDLE_DIR/docker/ss-sens/"
cp -r "$PROJECT_ROOT/config/ss-sens" "$BUNDLE_DIR/config/"
cp "$PROJECT_ROOT/src/ss_sens/env/prod.env" "$BUNDLE_DIR/env/"
cp "$PROJECT_ROOT/src/ss_sens/env/dev.env"  "$BUNDLE_DIR/env/"
cp "$PROJECT_ROOT/src/ss_sens/env/test.env" "$BUNDLE_DIR/env/"
...
cp "$PROJECT_ROOT/scripts/ss-sens/ss-sens-install.sh" "$BUNDLE_DIR/install.sh"
