...
#
# Usage:
#   ./scripts/sencoop/sencoop-release.sh [options]
#
# Options:
...
#
# Examples:
#   ./scripts/sencoop/sencoop-release.sh --version 1.2.0 --arch amd64
#   ./scripts/sencoop/sencoop-release.sh --version 1.2.0 --arch arm64 --bundle min
#   ./scripts/sencoop/sencoop-release.sh --bundle standard --with-metrics --yes
#   ./scripts/sencoop/sencoop-release.sh --no-images --no-docker-pkgs  # config-only test bundle
...
BUNDLE_SCRIPTS=(
  shared/common.sh
  sencoop/sencoop-ctl.sh
  sencoop/sencoop-bootstrap.sh
  sencoop/sencoop-compose.sh
  sencoop/sencoop-credentials.sh
  sencoop/sencoop-data-dirs.sh
  sencoop/sencoop-env.sh
  sencoop/sencoop-mosquitto-tls.sh
  sencoop/sencoop-mqtt-users.sh
)
...
cp "$PROJECT_ROOT/docker/sencoop/docker-compose.sencoop.yml" "$BUNDLE_DIR/docker/sencoop/"
cp -r "$PROJECT_ROOT/config/coop" "$BUNDLE_DIR/config/"
cp "$PROJECT_ROOT/src/sencoop/env/prod.env" "$BUNDLE_DIR/env/"
cp "$PROJECT_ROOT/src/sencoop/env/dev.env"  "$BUNDLE_DIR/env/"
cp "$PROJECT_ROOT/src/sencoop/env/test.env" "$BUNDLE_DIR/env/"
...
cp "$PROJECT_ROOT/scripts/sencoop/sencoop-install.sh" "$BUNDLE_DIR/install.sh"
