...
#
# Usage:
#   ./scripts/sencoop/sencoop-test-usb-cameras.sh           # List devices only
#   ./scripts/sencoop/sencoop-test-usb-cameras.sh --test    # List + test capture
...
echo ""
echo "Done. For Frigate USB camera setup, see docs/sencoop/sensor-integration.md"
