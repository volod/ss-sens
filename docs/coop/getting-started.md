...
```bash
./scripts/first_run_setup.sh --list
```
...
```bash
# RTSP camera
python scripts/add_camera.py --name front_door --rtsp rtsp://user:pass@192.168.1.100:554/stream1 --restart
...
python scripts/add_camera.py --list
```
